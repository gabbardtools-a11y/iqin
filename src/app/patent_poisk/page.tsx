...
export const metadata: Metadata = {
  ...
  description:
    "Бесплатные сервисы для поиска патентов: Яндекс.Патенты, Google Patents, Espacenet, Цифровая платформа Роспатента, WIPO Patentscope, ЕАПТ, ФИПС, Google Scholar.",
  keywords: [
    "поиск патентов",
    "проверка патента",
    "Яндекс.Патенты",
...
const DATABASES = [
  {
    ...
    category: "(РФ)",
    description: "Российские патенты с удобным поиском по тексту, авторам, номерам.",
  },
  {
    name: "Google Patents",
...
export default function PatentPoiskPage() {
  return (
    <SearchDatabasesPage
      ...
      description="Бесплатные сервисы для проверки новизны вашей идеи перед подачей заявки на патент. 8 российских и международных баз патентов — от Яндекс.Патенты до Google Patents и Espacenet."
      intro={[
        ...
        "Ниже — 8 проверенных баз патентов. Рекомендуем начать с российских (Яндекс.Патенты, ФИПС), затем проверить международные (Google Patents, Espacenet, WIPO). Для научных идей также полезен Google Scholar — там можно найти статьи, которые ещё не стали патентами.",
      ]}
      databases={DATABASES}
      accent="#A78BFA"
    />
